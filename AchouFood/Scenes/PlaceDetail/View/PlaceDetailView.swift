...
class PlaceDetailView: UIView {
    ...
    var presentRoute: ((CLLocationCoordinate2D, CLLocationCoordinate2D) -> Void)?
    var place: Place?
    ...
    let placeDetailsButtons: PlaceDetailButtons = {
    ...
    private func bindActions() {
        placeDetailsButtons.onTraceRouteTapped = { [weak self] in
            self?.verifyUserPermission()
        }
        
        placeDetailsButtons.onMenuTapped = { [weak self] in
...
extension PlaceDetailView: ViewCodeProtocol {
    func setViewHierarchy() {
        ...
        addSubview(mapView)
        addSubview(placeDetailsButtons)
    }
    ...
    func setViewConstraints() {
        ...
        placeImageView.snp.makeConstraints { make in
            ...
            make.leading.equalToSuperview().inset(PlaceDetailConstants.padding)
            make.size.equalTo(PlaceDetailConstants.placeImageSize)
        }
        
        titleLabel.snp.makeConstraints { make in
            make.top.equalTo(placeImageView.snp.bottom).offset(PlaceDetailConstants.padding)
        ...
        mapView.snp.makeConstraints { make in
            ...
            make.leading.trailing.bottom.equalToSuperview().inset(PlaceDetailConstants.padding)
        }
        
        placeDetailsButtons.snp.makeConstraints { make in
    ...
    func setViewConfigs() {
        ...
        placeDetailsButtons.layer.masksToBounds = true
        placeDetailsButtons.layer.cornerRadius = PlaceDetailConstants.buttonRadius
        placeDetailsButtons.layer.borderWidth = PlaceDetailConstants.buttonsBorder
        placeDetailsButtons.layer.borderColor = Color.gray100.cgColor
    }
}
...
extension PlaceDetailView {
    public func setup(place: Place) {
        ...
        placeDetailsButtons.setup(place: place)
